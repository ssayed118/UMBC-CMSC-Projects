...
private:
  ...
  bool insertLinear(Person person);
  bool insertQuad(Person person);
  bool removeLinear(Person person);
  bool removeQuad(Person person);
  void probingHelper(int size, Person *&newTable);
  bool rehashInsertLinear(Person *&newTable, Person person);
  bool rehashInsertQuad(Person *&newTable, Person person);
};
#endif
