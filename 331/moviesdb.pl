/*
This files has been download from the website:
https://swish.swi-prolog.org/example/movies.pl
The copyrights of this files belongs to its owners.
*/
...
*/
/*
"Discontiguous predicate" means that you defined 
more than one clause for a given predicate, but 
defined the cause of a different predicate in 
between. Prolog wants all of the clauses of a given 
predicate together. Therefore, the following 
predicate is there to avoid warning messages.
*/
